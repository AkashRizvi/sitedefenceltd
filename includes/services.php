        ...
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              <h6>
                Commercial Areas Security
              </h6>
              <p>
                We provide advanced security solutions to protect businesses, malls, and marketplaces, ensuring safety, crime prevention, and a secure environment for customers.
              </p>
        ...
        <div class="col-md-4">
          ...
          c10.095-0.01,18.276-8.191,18.286-18.286V283.429C475.419,273.334,467.238,265.153,457.143,265.143z" />
            ...
            <div class="detail-box">
              ...
              <p>
                Our office security services include surveillance, access control, and trained personnel, ensuring a safe workplace and protecting employees, assets, and data.
              </p>
              <a href="" class="rounded-pill">
                Read More
              </a>
        ...
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                We safeguard parks with trained security, CCTV monitoring, and patrols, ensuring a safe, peaceful environment for visitors, families, and recreational activities.
              </p>
              <a href="" class="rounded-pill">
                Read More
              </a>
